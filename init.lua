...
-- custom command to open init.lua (NeoVim Configuration)
vim.api.nvim_create_user_command('Init', function() vim.cmd('e $MYVIMRC') end, {})
...
--   See `:help 'clipboard'`
--   Comment this option for your OS clipboard to remain independent.
